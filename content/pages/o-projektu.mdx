...
authors: "knihovnaai"
summary: "Cílem knihovna.ai je mapovat budoucnost knihoven v éře umělé inteligence. Na této stránce se dočtete o podrobných východiscích, cílech i postupu projektového týmu."
---

<Section hero title="O projektu">

# Veřejné knihovny jako místa podpory budoucí zaměstnanosti

Co je naším cílem a jak postupujeme.
...
1. přizpůsobovat sociální záchrannou síť novým podmínkám na trhu práce a zefektivňovat proces rekvalifikace a kariérního poradenství,
2. motivovat do dalšího vzdělávání skupiny, které z celoživotního vzdělávání klasicky vypadávají,
3. navyšovat povědomí ohrožených skupin (ale i širší veřejnosti) o umělé inteligenci a o dopadech AI na společnost a budoucnost práce,
4. cíleně podporovat strukturálně postižené regiony, které pocítí dopady automatizace silněji než ostatní.
...
1. Pole příležitostí pro knihovny jako místa podpory budoucí zaměstnanosti není systematičtěji prozkoumáno a existující nabídka služeb knihoven typicky nezohledňuje nové nároky nastupující digitální transformace.

2. Nejen knihovnám, ale i dalším zainteresovaným stranám chybí informace o tom, jakým skupinám hrozí destabilizace na trhu práce, jak ohrožené skupiny oslovovat a aktivizovat, s jakými partnery je možné na podpoře zaměstnanosti spolupracovat.

3. Potřebná doporučení pro další rozvoj služeb nelze formulovat bez hlubšího porozumění potřebám, očekávání a bariérám cílových uživatelů. Výzkum perspektiv skupin, které AI může na trhu práce (dále) znevýhodnit, a sadu doporučení, jak tyto skupiny podporovat, v českých podmínkách postrádáme. Tímto projektem bychom je do českého prostředí rádi uvedli.
...
Celý plán naší práce lze rozdělit do 4 hlavních na sebe navazujících fází. Průběžnou aktivitou v projektu je komunitní kurátorství a zpřístupňování projektu účastníkům výzkumu, našim partnerům i náhodných kolemjdoucích. Považujeme pro to za důležité sdílet také podrobnější informace o proběhu výzkumu. Podívejte se na náš plán a sledujte tuto stránku pro získání hlubšího vhledu do běhu projektu.
...
<Section prose>
  ...
  <Placeholder>
    ...
    Zde brzy uvidíte popis jednotlivých fází projektu včetně možnosti sledovat, jak se nám daří a na jakých úkolech pracujeme.
